...
document.addEventListener("DOMContentLoaded", () => {
    // Solo renderiza productos si el contenedor existe en la página actual
    if (document.getElementById('productos')) {
        mostrarProductos(listadoProductos);
    }

    // Solo activa la escucha del formulario si el formulario de contacto existe
    if (document.getElementById('resultado') && document.getElementById('nombre')) {
        inicializarContacto();
    }
});